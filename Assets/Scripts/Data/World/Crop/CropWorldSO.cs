...
public class CropWorldSO : WorldSO
{
    #region ─────────────────────────▶ 인스펙터 ◀─────────────────────────
    [Header("농사 정보")]
    [SerializeField] private float[] _growTimes; // 단계벌 성장 필요 시간
    ...
    public override bool IsValid()
    {
        ...
        if (_growTimes == null) return false;
        if (_stageSprites == null) return false;
        ...
        for (int i = 0; i < length; ++i)
        {
            ...
            if (_stageSprites[i] == null) return false;
        }
